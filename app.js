...
var color1 = 'background-color: #' + random_color(h1) + random_color(h2) + random_color(h3) + random_color(h4) + random_color(h5) + random_color(h6);

var color2 = 'background-color: #' + random_color(h1) + random_color(h2) + random_color(h3) + random_color(h4) + random_color(h5) + random_color(h6);
